...
1.  Скачать Erlang с сайта (найти в гугле)

2.  Сохранить Erlang в хранилке (мы используем Артифакторий)

3.  Сделать новый Dockerfile, унаследоваться от windows-vc150

4.  Проверить с помощью USSF ключи тихой установки erlang

5.  Собрать Docker-образ

6.  Запустить Docker-образ, проверить что есть Erlang.exe --version?
